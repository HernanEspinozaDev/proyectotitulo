...
| --- | --- | --- | --- |
| Mercado Pago | La [documentación oficial de Split Payments 1:1](https://www.mercadopago.cl/developers/es/docs/split-payments/split-1-1/prerequisites) menciona integración de vendedores con OAuth y reparto de pagos. La apertura directa sigue devolviendo 403; los detalles nuevos de distribución, tarifa y devoluciones se contrastaron en el contenido indexado de las páginas oficiales y en [INV-012](INV-012_pagos_firma_identidad.md). | La tarifa de Mercado Pago se atribuye inicialmente al vendedor según la guía publicada. Dividir un pago no acredita custodia, retención, liberación ni garantía de ES1. Tampoco prueba habilitación comercial para el equipo. | Obtener condiciones escritas y entorno de prueba; medir tarifa y saldos de ambos participantes en cobro, devolución y conciliación. |
