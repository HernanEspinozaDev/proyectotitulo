---
titulo: "FORMULACIÓN DEL PROYECTO DE TÍTULO: EspaciGo"
proyecto: EspaciGo
lang: es-CL
institucion: Inacap - Informática y Telecomunicaciones
asignatura: Proyecto de Título - TIH184
seccion: D-IEI-N8-P1-C2/D
academico: Teresa Jesús Tapia Soto
integrantes: Hernán Espinoza, Anita Marchant, Erick Silva
...
El capítulo de fundamentación delimita el problema y los requisitos; el de propuesta formula los objetivos, la metodología y la arquitectura; y el de cierre presenta las conclusiones, las referencias y los anexos. El mapa siguiente resume esa organización antes de entrar en el detalle de cada apartado.

![Mapa de capítulos del informe](imagenes/figura-mapa-documento.png){width=6.3in} <!--#fig:mapa-documento-->
...
Los informes de mercado del sector inmobiliario permiten dimensionar el fenómeno con cifras verificables. Al cierre del primer trimestre de 2026, la vacancia de oficinas en Santiago se situaba en torno al 9,9%, equivalente a cerca de 255.000 m² sin arrendar, después de haber cerrado 2025 en 10,1% [@colliers2026]; la medición de CBRE, por su parte, reporta una vacancia general de 9,64% y de 9,22% en oficinas clase A, la más baja de los últimos cinco años [@cbre2026]. La vacancia se concentra con mayor intensidad en los edificios de menor calidad y en los submercados periféricos, que compiten con dificultad frente a la oferta nueva de Providencia, Las Condes y el eje El Bosque-El Golf. A este escenario se suma la presión del mercado de bodegaje y galpones industriales, donde la sobreoferta de metros cuadrados construidos y la moderación del comercio masivo han incrementado la disponibilidad de espacios vacíos, aunque para este segmento no se identificó un informe público con una cifra verificable en la misma fecha de referencia.
...
Las causas que sostienen esta situación se ordenan en el diagrama siguiente, que agrupa los factores de oferta, de costo, de trazabilidad y de demanda que la plataforma busca atacar.

![Árbol de causas de la vacancia y de la exclusión de las pymes](imagenes/figura-problema-causas.png){width=6.3in} <!--#fig:problema-causas-->

La magnitud del fenómeno varía según el segmento del mercado, como muestra la siguiente comparación de las tasas de vacancia reportadas por el sector.

![Magnitud del problema por segmento de mercado](imagenes/figura-problema-magnitud.png){width=6.3in} <!--#fig:problema-magnitud--> <!--#fuente:CBRE Chile (2026) y Colliers International (2026), informes del primer trimestre de 2026.-->
...
La relevancia de este problema es de alto impacto económico y está respaldada por el comportamiento reciente del mercado de oficinas y de espacios flexibles en Chile. Los informes de mercado del primer trimestre de 2026 muestran que la vacancia de oficinas en Santiago sigue siendo elevada, aunque decreciente: CBRE reporta una tasa general de 9,64% y de 9,22% en oficinas clase A —la más baja de los últimos cinco años— [@cbre2026], mientras que Colliers sitúa la vacancia general en 9,9%, equivalente a cerca de 255.000 m² sin arrendar, después de cerrar 2025 en 10,1% [@colliers2026]. En términos prácticos, alrededor de uno de cada diez metros cuadrados de oficina de la capital permanece sin generar ingresos, y son los edificios de menor calidad y más antiguos los que enfrentan mayor dificultad para competir con la oferta nueva.

A esta situación se suma la sobreoferta de espacios de bodegaje y de locales en ejes secundarios, donde la disponibilidad se ha mantenido alta por la moderación del comercio y por la entrada de nueva superficie construida. Para estos segmentos no se identificó un informe público con una cifra verificable en la misma fecha de referencia, de modo que este informe los describe de forma cualitativa y no les atribuye un porcentaje.

Esta acumulación de espacio disponible representa pérdidas para los arrendadores y, al mismo tiempo, la demanda por espacios altamente flexibles y de "última milla" por parte del comercio electrónico ha aumentado, lo que demuestra un descalce entre la oferta rígida tradicional y las nuevas necesidades dinámicas del mercado.
...
1.  **Complejidad Legal y Normativa:** El arriendo, aunque sea temporal, debe proveer seguridad jurídica para facilitar eventuales desalojos. Esto exige el cumplimiento estricto de la Ley 21.461 ("Devuélveme mi Casa") [@ley21461], lo que obliga al sistema a generar contratos dinámicos que se integren vía API con un proveedor externo de firma electrónica avanzada remota. Además, el manejo de documentos de identidad debe cumplir con los altos estándares de privacidad y protección de datos personales de la Ley 21.719 [@ley21719]. Cabe precisar que estas funcionalidades se orientan a **apoyar** el cumplimiento de los requisitos legales aplicables: el sistema incorpora los mecanismos tecnológicos de generación, firma y resguardo documental, mientras que la validez y los efectos jurídicos de cada contrato se rigen por la normativa vigente y la voluntad de las partes.
...
3.  **Estudio de Mercado y Benchmark Competitivo:** Para identificar brechas de diseño funcional frente a competidores tradicionales (Mercado Libre, Mudango) [@mercadolibre; @mudango].
...
Para reflejar la envergadura de una plataforma SaaS Cloud-Native y cumplir con los más altos estándares de Ingeniería de Software, se ha seleccionado una metodología híbrida. Esta combina un modelo de procesos iterativo-incremental para la construcción técnica, junto con las mejores prácticas del PMBOK [@pmbok7] para la gestión del proyecto.

Se justifica el uso de este enfoque predictivo e iterativo debido a que los requerimientos de la plataforma (financieros, legales y de seguridad) son estables y predecibles, no existiendo un cliente final que cambie los requerimientos estructurales constantemente. La documentación se organiza por incrementos, de modo que cada iteración conserva la trazabilidad entre los requerimientos definidos y las historias de usuario y casos de uso que los implementan.
...
*Tabla. Resumen de los artefactos de requisitos del proyecto.* <!--#tab:artefactos-->

| Artefacto | Cantidad | Identificadores | Organización | Ubicación del detalle completo |
| :--- | :--- | :--- | :--- | :--- |
| Actores y módulos funcionales | 9 actores (5 primarios y 4 sistemas externos) | M01–M11 | 11 módulos funcionales | Anexo A — Actores y módulos del sistema |
| Requerimientos funcionales | **236** | `RQF-001` a `RQF-236` | 11 módulos funcionales (M01–M11) | Anexo B — Catálogo de requerimientos funcionales (extracto en la {{Tabla:rf}}) |
| Requerimientos no funcionales | **43** | `RNF-001` a `RNF-043` | 11 categorías (mínimo 3 por categoría) | Anexo C — Requerimientos no funcionales (extracto en la {{Tabla:rnf}}) |
| Casos de uso | **52** | `CU-01` a `CU-52` | 11 módulos funcionales, un diagrama UML por módulo | Anexo D — Especificación de casos de uso (diagramas incluidos) |
| Historias de usuario | **35** | `HU01` a `HU35` | 9 épicas (E1–E9) | Anexo E — Historias de usuario (extracto en la {{Tabla:hu}}) |
...
Los cuatro artefactos no son listas independientes: las historias de usuario se implementan mediante requerimientos funcionales, estos se especifican en casos de uso y los requerimientos no funcionales condicionan ambos niveles. El diagrama siguiente representa esa cadena de trazabilidad, que se detalla en la matriz de trazabilidad de este informe.

![Cadena de trazabilidad de los artefactos de requisitos](imagenes/figura-req-artefactos.png){width=6.3in} <!--#fig:req-artefactos-->
...
Los requerimientos no funcionales establecen los límites físicos, de calidad y legislativos del sistema. A continuación se presenta un extracto con los 8 requerimientos más críticos del proyecto, clasificados según las categorías y subcategorías del estándar ISO/IEC 25010 [@iso25010] y del modelo de Sommerville [@sommerville]. El catálogo completo de los **43 requerimientos no funcionales** se presenta en el **Anexo C**: están clasificados en 11 categorías (Rendimiento, Usabilidad, Fiabilidad, Seguridad, Flexibilidad, Mantenibilidad, Compatibilidad, Portabilidad, Implementación, Almacenamiento y Requerimientos Externos) con un mínimo de 3 requerimientos por categoría, redactados en el formato estándar "El sistema debe [condición de calidad]", y cada uno declara su trazabilidad hacia los requerimientos funcionales y los módulos que condiciona. El catálogo incorpora además criterios de accesibilidad conforme a WCAG 2.1 nivel AA [@wcag21] y de cumplimiento de estándares de la industria de medios de pago [@pcidss]. Ninguno de ellos describe comportamiento funcional: las acciones observables por los actores se especifican exclusivamente en el catálogo de requerimientos funcionales.

*Tabla. Requerimientos no funcionales (extracto de los 8 más críticos).* <!--#tab:rnf-->
...
| RNF-017 | Seguridad / Integridad | El sistema debe preservar los logs de auditoría transaccional en un repositorio inmutable, bloqueando a nivel de infraestructura cualquier intento de modificación o eliminación de los registros. |
...
| RNF-025 | Requerimientos Externos / Estándares | El sistema debe procesar los pagos exclusivamente mediante tokenización, sin almacenar en la base de datos los datos PAN o CVV, para dar estricto cumplimiento al estándar PCI-DSS. |
...
![Diagrama de casos de uso del módulo M01 — Autenticación y Gestión de Cuenta](imagenes/figura-m01.png) <!--#fig:m01-->
...
![Diagrama de casos de uso del módulo M02 — Perfil y Privacidad del Usuario](imagenes/figura-m02.png) <!--#fig:m02-->
...
![Diagrama de casos de uso del módulo M03 — Verificación de Identidad (KYC/KYB)](imagenes/figura-m03.png) <!--#fig:m03-->
...
![Diagrama de casos de uso del módulo M04 — Gestión de Publicaciones](imagenes/figura-m04.png) <!--#fig:m04-->
...
![Diagrama de casos de uso del módulo M05 — Búsqueda y Cotización de Espacios](imagenes/figura-m05.png) <!--#fig:m05-->
...
![Diagrama de casos de uso del módulo M06 — Reservas y Pagos (Escrow)](imagenes/figura-m06.png) <!--#fig:m06-->
...
![Diagrama de casos de uso del módulo M07 — Contratos y Firma Electrónica](imagenes/figura-m07.png) <!--#fig:m07-->
...
![Diagrama de casos de uso del módulo M08 — Check-in y Check-out](imagenes/figura-m08.png) <!--#fig:m08-->
...
![Diagrama de casos de uso del módulo M09 — Comunicación y Reputación](imagenes/figura-m09.png) <!--#fig:m09-->
...
![Diagrama de casos de uso del módulo M10 — Disputas, Payout y Facturación](imagenes/figura-m10.png) <!--#fig:m10-->
...
![Diagrama de casos de uso del módulo M11 — Administración y Auditoría](imagenes/figura-m11.png) <!--#fig:m11-->
...
Cada historia declara su épica, su prioridad, los requerimientos funcionales que la implementan y los casos de uso donde está especificada, de modo que existe trazabilidad directa entre HU, RF y CU. Los criterios que describen funcionalidad fuera del alcance declarado de esta entrega se identifican explícitamente en su bloque "Fuera del alcance de la ES1". A continuación se presenta un extracto con las 8 historias más críticas del flujo principal de negocio, en formato "Como / Quiero / Para" y con un resumen de sus criterios de aceptación. El conjunto completo de las **35 historias** —cada una con sus criterios de aceptación detallados, su tabla de trazabilidad HU ↔ RF ↔ CU, la cobertura de los 11 módulos funcionales y el detalle de las correcciones aplicadas— se presenta en el **Anexo E**.

*Tabla. Historias de usuario (extracto de las 8 historias más críticas).* <!--#tab:hu-->
...
*Tabla. Del requisito del negocio a la validación técnica.* <!--#tab:negocio-->
...
*Tabla. Matriz de trazabilidad integral (HU → RF → RNF → CU → Módulo → Componente).* <!--#tab:matriz-->
...
*   **RNF → RF y RNF → módulos:** declarada en el Anexo C.
*   **RF → módulo:** declarada en el Anexo A (módulos del sistema) y en el Anexo B (catálogo de requerimientos).
...
*Tabla. Comparación SaaS vs On-Premise.* <!--#tab:saas-->
...
**Decisión de implementación:** EspaciGo se diseña como una solución web basada en la nube, con acceso centralizado y escalado automático. Se privilegia el modelo SaaS por sus ventajas documentadas de elasticidad y pago por uso frente a la operación de infraestructura propia [@armbrust2010].

El diagrama siguiente contrasta el modelo adoptado con la alternativa on-premise descartada, en términos de quién opera la infraestructura y qué efectos tiene esa decisión para el proyecto.

![Comparación entre el modelo SaaS adoptado y el modelo On-Premise](imagenes/figura-s4-saas.png){width=6.3in} <!--#fig:s4-saas-->

### Marketplace y modelo B2B2C

Un marketplace es una plataforma digital que conecta dos o más grupos de actores para facilitar la interacción y transacción [@tiwana2014].

*Tabla. Marketplace y modelo B2B2C.* <!--#tab:b2b2c-->
...
La plataforma conecta a los dos lados del mercado y su valor se concentra en la confianza transaccional de la operación, como representa el diagrama siguiente.

![Modelo de plataforma de dos lados de EspaciGo](imagenes/figura-s4-marketplace.png){width=6.3in} <!--#fig:s4-marketplace-->

### Modelos de negocio y monetización digital

*Tabla. Modelos de monetización frecuentes.* <!--#tab:monetizacion-->
...
El modelo de comisión transaccional se materializa en el flujo de pago, retención, liberación y facturación que muestra el diagrama de secuencia siguiente.

![Flujo del modelo de comisión transaccional](imagenes/figura-s4-monetizacion.png){width=6.3in} <!--#fig:s4-monetizacion-->

### Cloud Computing, arquitectura web y APIs

*Tabla. Arquitectura monolítica vs distribuida.* <!--#tab:arquitecturas-->
...
**Decisión de implementación:** Arquitectura **modular cloud-native**, con servicios encapsulados para frontend, negocio, persistencia, pago, identidad, documento y auditoría. Los módulos se despliegan como una unidad contenerizada sobre un servicio serverless gestionado [@docker; @cloudrun; @armbrust2010], por lo que no se adoptan microservicios con despliegue, datos y ciclo de vida independientes.

La arquitectura modular adoptada se organiza en capas, con los once módulos funcionales concentrados en la capa de negocio, como muestra el diagrama siguiente.

![Capas de la arquitectura modular cloud-native de EspaciGo](imagenes/figura-s4-capas-arquitectura.png){width=6.3in} <!--#fig:s4-capas-arquitectura-->
...
**Decisión de implementación:** El sistema implementa validaciones transaccionales en PostgreSQL [@postgresql] para prevenir solapamientos y generar bloqueos lógicos del intervalo, apoyándose en la extensión geoespacial PostGIS [@postgis] para la geolocalización de las publicaciones.

El diagrama siguiente ilustra la condición de carrera que origina la doble reserva y el control transaccional que la resuelve.

![Condición de carrera de la doble reserva y su control transaccional](imagenes/figura-s4-doble-reserva.png){width=6.3in} <!--#fig:s4-doble-reserva-->
...
*Tabla. Comparación de mecanismos de pago.* <!--#tab:pagos-->
...
**Decisión de implementación:** Utilizar Mercado Pago con soporte a retención de fondos (Escrow), reparto de pagos entre las partes (Split) y webhooks, sin almacenar datos de tarjeta en la plataforma, conforme al estándar PCI-DSS [@mercadopago; @pcidss].

El ciclo completo del mecanismo de custodia, incluidos los dos desenlaces posibles del cierre de la reserva, se representa en el diagrama siguiente.

![Ciclo de retención, liberación y ejecución de la garantía (Escrow)](imagenes/figura-s4-escrow.png){width=6.3in} <!--#fig:s4-escrow-->

### KYC, KYB, identidad digital y autenticación

*Tabla. Diferencia entre KYC y KYB.* <!--#tab:kyc-->
...
**Decisión de implementación:** EspaciGo adopta identidad verificada con KYC/KYB cruzando datos con el Registro Civil y el SII.

El proceso de verificación atraviesa estados verificables por el propio sistema, lo que permite restringir la publicación y el pago a las identidades acreditadas.

![Estados del proceso de verificación de identidad (KYC y KYB)](imagenes/figura-s4-kyc-estados.png){width=6.3in} <!--#fig:s4-kyc-estados-->

### Seguridad, privacidad y protección de datos personales

La normativa chilena (Ley 21.719) [@ley21719] establece principios como finalidad, minimización, transparencia, seguridad y eliminación.

*Tabla. Matriz de seguridad y privacidad.* <!--#tab:seguridad-->
...
**Decisión de implementación:** Privacidad por diseño y seguridad aplicada por capas, con almacenamiento de contraseñas mediante hash irreversible bcrypt [@bcrypt] y cifrado de datos sensibles en reposo.

El control de seguridad se organiza en capas y la privacidad se incorpora como criterio de diseño en cada una de ellas, según muestra el diagrama siguiente.

![Capas de seguridad y privacidad por diseño](imagenes/figura-s4-seguridad-capas.png){width=6.3in} <!--#fig:s4-seguridad-capas-->

### Contratos digitales, firma electrónica y gestión documental

*Tabla. Firma electrónica.* <!--#tab:firma-->
...
**Decisión de implementación:** Flujo de contratos digitales con generación automática e integración con un proveedor de firma electrónica avanzada remota [@firmavirtual; @ley19799], en el marco de los requisitos de contratación de la Ley 21.461 [@ley21461].

El diagrama siguiente recorre el flujo de generación, envío a firma, confirmación y resguardo del contrato asociado a la reserva.

![Flujo de generación, firma y resguardo del contrato](imagenes/figura-s4-contrato-firma.png){width=6.3in} <!--#fig:s4-contrato-firma-->

### Auditoría, trazabilidad y resolución de disputas

*Tabla. Evidencia digital y su valor probatorio.* (Adaptada) <!--#tab:evidencia--> <!--#fuente:elaboración propia a partir del modelo de auditoría basado en eventos descrito en este capítulo.-->
...
**Decisión de implementación:** Modelo de auditoría basado en eventos utilizando Google BigQuery [@bigquery] como repositorio analítico inmutable.

El recorrido del evento de auditoría, desde la acción del usuario hasta su consulta en la resolución de una disputa, se resume en el diagrama siguiente.

![Flujo de auditoría y trazabilidad de las acciones críticas](imagenes/figura-s4-auditoria.png){width=6.3in} <!--#fig:s4-auditoria-->

### Arquitectura de software y metodologías

El proyecto adopta una **arquitectura de componentes modulares** desplegada en contenedores sobre un servicio serverless gestionado, en lugar de un monolito tradicional o de un modelo de microservicios con despliegue independiente [@sommerville]. La comparación de estilos arquitectónicos presentada en este capítulo justifica la decisión: se obtiene el aislamiento y la portabilidad que entregan los contenedores, junto con el escalamiento automático del proveedor cloud, sin asumir el costo operativo de coordinar servicios autónomos con bases de datos y ciclos de despliegue independientes.

Respecto de la metodología, la construcción se organiza mediante un ciclo de vida iterativo e incremental —con incrementos funcionales verificables al cierre de cada iteración— y la gestión del proyecto se apoya en las prácticas del PMBOK [@pmbok7] para el alcance, el cronograma, los riesgos y los interesados. La correspondencia entre los requisitos del negocio, los casos de uso, los componentes técnicos y su validación se detalla en la sección de matriz de trazabilidad de este informe.

El diagrama siguiente contrasta los tres estilos considerados y señala el adoptado, con el motivo de cada descarte.

![Comparación de estilos arquitectónicos y opción adoptada](imagenes/figura-s4-estilos-arquitectura.png){width=6.3in} <!--#fig:s4-estilos-arquitectura-->
...
La solución se formula como una plataforma web transaccional de tipo SaaS y Marketplace B2B2C, cuya unidad funcional se organiza en once módulos: autenticación y gestión de cuenta (M01), perfil y privacidad del usuario (M02), verificación de identidad KYC/KYB (M03), gestión de publicaciones (M04), búsqueda y cotización de espacios (M05), reservas y pagos con retención de fondos (M06), contratos y firma electrónica (M07), check-in y check-out (M08), comunicación y reputación (M09), disputas, liquidación y facturación (M10), y administración y auditoría (M11). Cada módulo se especifica mediante un diagrama de casos de uso y fichas trazables hacia los requerimientos funcionales. La plataforma se construye sobre una arquitectura Cloud-Native de componentes modulares: capa de presentación en Next.js [@nextjs], backend en Go [@golang], PostgreSQL con PostGIS [@postgresql; @postgis] como base operativa y BigQuery [@bigquery] como repositorio analítico inmutable, con Mercado Pago como pasarela de pagos con tokenización y retención de fondos (Escrow) y FirmaVirtual como proveedor de firma electrónica avanzada.

El modelo de negocio de la solución se sintetiza en el siguiente lienzo, que relaciona la propuesta de valor con los segmentos atendidos, los recursos y actividades que la sostienen, los canales de contacto y su estructura de costos e ingresos.

![Lienzo canvas del modelo de negocio de EspaciGo](imagenes/figura-canvas.png){width=6.3in} <!--#fig:canvas-->
...
El impacto de la solución se describe a continuación en términos del proceso de negocio afectado, los interesados involucrados, los indicadores de gestión del proyecto y los niveles de servicio comprometidos por la plataforma.

### Proceso de negocio afectado

El proyecto interviene el proceso de comercialización y arriendo de espacios flexibles, que en la situación actual se ejecuta de forma presencial, con contratos rígidos y sin trazabilidad de la operación. La solución rediseña seis procesos de negocio:

1.  **Registro y verificación de identidad:** la validación de personas naturales y empresas se resuelve en línea contra el Registro Civil y el SII, y reemplaza la verificación presencial de antecedentes por un flujo digital con estados verificables ("No Verificada", "Pendiente de Verificación", "Verificada_KYC" y "Verificado_KYB").
2.  **Publicación y gestión de disponibilidad:** el arrendador registra el espacio, sus tarifas, reglas de uso y política de cancelación, y administra su calendario de disponibilidad por hora, día o mes, con bloqueos manuales y control de estados de la publicación (Borrador, Activa, Oculta).
3.  **Búsqueda, cotización y reserva:** el arrendatario busca por texto, filtros y mapa, cotiza el desglose del cobro (estadía, comisión de servicio y garantía) y solicita la reserva, la cual se valida contra la disponibilidad real para evitar la doble reserva.
4.  **Pago con retención de fondos:** el pago se procesa mediante tokenización en la pasarela y los fondos permanecen retenidos en custodia (Escrow) junto con una pre-autorización por la garantía; la liberación de los fondos queda condicionada al cumplimiento de las condiciones de cierre de la reserva.
5.  **Contratación digital:** el sistema genera el contrato con los datos de las partes y del inmueble, lo envía a firma electrónica avanzada remota y almacena el documento firmado como constancia formal de la reserva.
6.  **Operación, cierre y resolución de disputas:** el check-in y el check-out se documentan con evidencia fotográfica, el arrendador confirma la recepción del espacio, ambas partes pueden calificarse, y el cierre financiero contempla el registro de reclamos dentro de las 24 horas posteriores al término, el arbitraje administrativo de la garantía y la liquidación con emisión de la boleta de comisión.

El proceso de negocio rediseñado involucra a ambos clientes, a la plataforma y a los terceros que intervienen en la validación y la firma, como muestra el diagrama de actividades con carriles siguiente.

![Proceso de negocio rediseñado por EspaciGo](imagenes/figura-proceso-negocio.png){width=6.3in} <!--#fig:proceso-negocio-->

### Registro de Interesados

*Tabla. Registro de Interesados.* <!--#tab:interesados-->
...
Los indicadores de gestión del proyecto se derivan del propio catálogo de requisitos, de modo que su cumplimiento sea medible y verificable:

*Tabla. Indicadores de gestión del proyecto.* <!--#tab:indicadores-->

| Indicador | Fórmula de cálculo | Meta | Fuente de verificación |
| :--- | :--- | :--- | :--- |
| Cobertura de requerimientos funcionales | RF con caso de uso responsable / total de RF | 100% (236/236) | Anexo de Requerimientos Funcionales y anexo de Casos de Uso |
| Trazabilidad de historias de usuario | HU con RF y CU declarados / total de HU | 100% (35/35) | Matriz de trazabilidad del informe y anexo de Historias de Usuario |
| Cobertura funcional de los módulos | Módulos con al menos una HU / total de módulos | 100% (11/11) | Anexo de Historias de Usuario |
| Cumplimiento de categorías de calidad | Categorías de RNF con 3 o más requerimientos / total de categorías | 100% (11/11) | Anexo de Requerimientos No Funcionales |
| Avance incremental | Incrementos cerrados con entregable verificado / incrementos planificados | 6 de 6 al término de la semana 16 | Cronograma del proyecto |
| Cumplimiento del cronograma | Hitos entregados en la semana planificada / hitos totales | 100% | Cronograma del proyecto |
| Cobertura de pruebas automatizadas | Cobertura de pruebas unitarias sobre la capa de negocio | 80% mínimo | Pipeline de integración continua (RNF-021) |
| Ejecución presupuestaria | Costo real valorizado / presupuesto valorizado | 100% | Plan de recursos del proyecto |

### Niveles de servicio

Los niveles de servicio comprometidos por la plataforma se derivan de los requerimientos no funcionales del catálogo, lo que permite verificarlos con criterios objetivos:

*Tabla. Niveles de servicio comprometidos por la plataforma.* <!--#tab:sla-->

| Dimensión | Compromiso de servicio | Verificación |
| :--- | :--- | :--- |
| Disponibilidad de funciones críticas | 99,9% mensual (autenticación, búsqueda y reservas) | RNF-009 |
| Rendimiento de búsqueda | Resultados en máximo 2 segundos con 200 usuarios concurrentes | RNF-001 |
| Rendimiento del flujo de pago | Ciclo de pago retenido (Escrow) en máximo 8 segundos, sin contar la pasarela externa | RNF-002 |
| Generación de contratos | Contrato PDF disponible en máximo 10 segundos | RNF-003 |
| Capacidad | 500 usuarios concurrentes y 100 escrituras por segundo | RNF-030 |
| Resiliencia ante fallos | Rollback automático en el flujo de pagos | RNF-011 |
| Recuperación de la base de datos | RPO máximo de 4 horas y RTO máximo de 6 horas | RNF-010 |
| Escalamiento | Absorción de incrementos del 200% de carga con nuevas instancias en máximo 10 minutos | RNF-019 |
| Seguridad de credenciales | Hash irreversible con bcrypt (mínimo 12 rounds) y TLS 1.2 o superior | RNF-013, RNF-015 |
| Retención de información | Contratos, evidencias y registros de auditoría por un mínimo de 5 años | RNF-042, RNF-043 |
| Plazos legales al usuario | Eliminación o rectificación de datos en máximo 72 horas; boleta timbrada en máximo 24 horas | RNF-026, RNF-027 |
...
1.  **OE1 — Infraestructura y despliegue:** Diseñar e implementar la infraestructura operativa basada en contenedores (Docker) para su despliegue continuo (CI/CD) en Google Cloud Platform.
2.  **OE2 — Núcleo lógico:** Desarrollar el núcleo lógico construyendo un Backend concurrente en Golang y un Frontend en Next.js.
3.  **OE3 — Integraciones críticas:** Integrar servicios críticos consumiendo la API de Mercado Pago (Escrow) y la API de FirmaVirtual.
4.  **OE4 — Auditoría y datos:** Configurar un módulo de auditoría y bases de datos bimodales (PostgreSQL/BigQuery) para registrar eventos inmutables.

Cada objetivo específico queda vinculado a los indicadores de gestión y niveles de servicio definidos en este capítulo: OE1 y OE4 a los indicadores de disponibilidad y trazabilidad, OE2 a los de rendimiento y concurrencia, y OE3 a los de éxito transaccional e integración.

Los objetivos específicos se derivan del objetivo general y cada uno se asocia a un resultado verificable del proyecto, como muestra el diagrama siguiente.

![Despliegue de los objetivos general y específicos](imagenes/figura-objetivos-arbol.png){width=6.3in} <!--#fig:objetivos-arbol-->

# Metodología de Trabajo

## Metodología de Desarrollo de la solución

Se ha optado por implementar una **Metodología Híbrida**, combinando un ciclo Iterativo e Incremental con las mejores prácticas de gestión del PMBOK [@pmbok7].

Esta decisión se justifica porque los requerimientos de la plataforma (financieros, legales y de seguridad) son estables y predecibles, y no existe un cliente final que modifique los requerimientos estructurales de forma constante. El ciclo iterativo e incremental permite construir el producto en incrementos funcionales verificables —uno por cada bloque de módulos—, mientras que las prácticas del PMBOK aportan el control de alcance, cronograma, riesgos e interesados que exige la naturaleza regulatoria del negocio.

La documentación se estructura separando los requerimientos funcionales, especificados conforme al estándar IEEE 830 [@ieee830], de las historias de usuario y los casos de uso, que se desarrollan en las iteraciones definidas en el cronograma.

El ciclo de vida adoptado repite la secuencia de planificación, construcción, pruebas y entrega de un incremento verificable, bajo el control de alcance y riesgos del PMBOK.

![Ciclo de vida iterativo e incremental del proyecto](imagenes/figura-ciclo-incremental.png){width=6.3in} <!--#fig:ciclo-incremental-->

## Duración y cronograma

El proyecto contempla **16 semanas** de desarrollo, distribuidas en seis incrementos funcionales más una etapa de iniciación y una de cierre. Cada incremento agrupa un bloque de módulos y cierra con un entregable verificable, de modo que el avance del proyecto es medible en función de funcionalidad operativa y no solo de documentación.

*Tabla. Cronograma del proyecto en 16 semanas (6 incrementos).* <!--#tab:cronograma-->

| Periodo | Etapa / incremento | Alcance funcional | Entregable de cierre |
| :--- | :--- | :--- | :--- |
| Semanas 1–2 | Iniciación | Levantamiento y validación de requerimientos, arquitectura de la solución, definición del backlog por módulos, entorno de contenedores y pipeline CI/CD | Documento de requerimientos aprobado y arquitectura definida |
| Semanas 3–4 | Incremento 1: Identidad y acceso | M01 Autenticación y gestión de cuenta, M02 Perfil y privacidad, M03 Verificación de identidad (KYC/KYB) | Registro, autenticación y verificación de identidad operativos |
| Semanas 5–7 | Incremento 2: Oferta y búsqueda | M04 Gestión de publicaciones, M05 Búsqueda y cotización de espacios | Catálogo con publicación, calendario de disponibilidad, búsqueda, filtros y mapa |
| Semanas 8–10 | Incremento 3: Reservas y pagos | M06 Reservas y pagos (Escrow): validación de disponibilidad, reserva, pago con retención y pre-autorización de garantía | Flujo transaccional de reserva y pago con retención de fondos |
| Semanas 11–12 | Incremento 4: Contratación y operación | M07 Contratos y firma electrónica, M08 Check-in y check-out | Contrato generado y firmado, check-in/check-out con evidencia y confirmación de recepción |
| Semanas 13–14 | Incremento 5: Reputación, disputas y liquidación | M09 Comunicación y reputación, M10 Disputas, payout y facturación | Reseñas, reclamos, arbitraje de garantía, liquidación y boleta de comisión |
| Semanas 15–16 | Cierre: Administración, validación y entrega | M11 Administración y auditoría, pruebas de aceptación (UAT), corrección de hallazgos y documentación final | Versión candidata validada y documentación de entrega |

**Nota.** Las semanas de la tabla se cuentan desde el inicio del proyecto y su equivalencia en fechas se deriva de la fecha de entrega de esta formulación (15 de septiembre de 2026), que corresponde al cierre del cronograma en la semana 16. Bajo ese supuesto, la semana 1 corresponde a la última semana de mayo de 2026 (desde el 26 de mayo) y el cierre se sitúa en la primera quincena de septiembre de 2026. La asignación definitiva de fechas debe ser validada por el equipo con la planificación académica de la asignatura.

La distribución de las 16 semanas entre la etapa de iniciación, los cinco incrementos funcionales y el cierre se representa en el cronograma siguiente, complementario a la tabla anterior.

![Cronograma del proyecto en 16 semanas](imagenes/figura-cronograma.png){width=6.3in} <!--#fig:cronograma-->

## Equipo de trabajo

El equipo se compone de tres roles funcionales, cada uno responsable de un dominio de la arquitectura y de sus entregables. La asignación de responsabilidades se formaliza en la matriz RACI siguiente, donde **R** ejecuta la actividad, **A** aprueba y rinde cuentas por el resultado, **C** es consultado antes de decidir e **I** es informado del avance.

*Tabla. Matriz RACI de responsabilidades por dominio de trabajo.* <!--#tab:raci-->

| Actividad | Hernán Espinoza (Gerencia / Arquitecto Cloud) | Erick Silva (Análisis / Backend) | Anita Marchant (Desarrollo / UI-UX) | Docente guía |
| :--- | :---: | :---: | :---: | :---: |
| Definición de arquitectura, seguridad e infraestructura | R, A | C | C | I |
| Diseño de base de datos (OLTP/OLAP) y pipeline CI/CD | R, A | C | I | I |
| Levantamiento y validación de requerimientos | C | R, A | C | I |
| Desarrollo del backend, reservas y pagos (Escrow) | C | R, A | C | I |
| Integración de Mercado Pago y FirmaVirtual | C | R, A | I | I |
| Desarrollo del frontend y prototipado en Figma | I | C | R, A | I |
| Gestión de riesgos y del cronograma | R, A | C | C | I |
| Pruebas de aceptación y validación con usuarios | C | C | R, A | I |
| Documentación técnica y entrega del informe | C | R | C | A |

**Nota.** Cada actividad mantiene un único responsable de ejecución (R) y un único responsable de aprobación (A), de modo que ninguna actividad queda sin dueño; el rol docente actúa como aprobador externo de la entrega documental.
...
## Definir el tipo de arquitectura TI que requiere la solución informática
...
El diagrama de contexto muestra los actores que interactuán con la plataforma y los sistemas externos con los que se integra, precisando el propósito de cada integración.

![Diagrama de contexto de la arquitectura de EspaciGo](imagenes/figura-arq-contexto.png){width=6.3in} <!--#fig:arq-contexto-->

**Decisiones Tecnológicas:**

*   **Capa de Presentación:** `Next.js` (Elegido por su SEO vía SSR frente a React SPA puro o Angular) [@nextjs].
*   **Capa Lógica (Backend):** `Go` (Golang) (Elegido por su manejo concurrente nativo, bajo consumo y compatibilidad con despliegues en GCP, descartando Node.js y Java como estándar oficial del proyecto) [@golang].
*   **Base de Datos Operativa (OLTP):** `PostgreSQL` (garantiza transacciones ACID y aporta PostGIS para la geolocalización de las publicaciones) [@postgresql; @postgis].
*   **Infraestructura Cloud:** `GCP Cloud Run` (Serverless, pago por uso) [@cloudrun].
*   **Empaquetado:** `Docker` (Garantiza consistencia entre entornos) [@docker].
*   **Auditoría y Logs (OLAP):** `Google BigQuery` (Almacenamiento inmutable para cumplir Ley 21.719) [@bigquery].
...
La topología del sistema detalla cómo se despliegan estos componentes: la canalización de integración continua publica las imágenes de contenedor, Cloud Run ejecuta la capa de presentación y la API, y la API se conecta a la base operativa, al almacenamiento de archivos, al repositorio analítico y a los servicios externos.

![Topología del sistema EspaciGo](imagenes/figura-arq-topologia.png){width=6.3in} <!--#fig:arq-topologia-->

# Reconocimiento de arquitectura empresarial

## Identificación del tipo de organización y su estructura

La organización se configura como una Startup de Base Tecnológica (Emprendimiento) con una estructura plana de tres roles funcionales, organizada para operar un modelo de negocio SaaS de tipo Marketplace B2B2C.

La descripción de la organización se ordena por dominios de arquitectura empresarial (negocio, aplicaciones, datos y tecnología), un enfoque compatible con marcos de referencia ampliamente utilizados —como TOGAF— que organiza la arquitectura en esas mismas capas y exige explicitar su relación con los objetivos del negocio.
...
La organización se estructura en tres roles funcionales, apoyados por contrapartes externas. El rol de Gerencia concentra la arquitectura cloud y la gestión de riesgos, el rol de Gestión de Personas y Análisis Tecnológica asume el levantamiento de requerimientos y el backend, y el rol de Desarrollo y Arquitectura se hace cargo de la interfaz de usuario y del frontend.

![Organigrama de funciones de EspaciGo](imagenes/figura-ae-organigrama.png){width=6.3in} <!--#fig:ae-organigrama-->
...
Los cuatro dominios de la arquitectura empresarial se relacionan de forma descendente: los procesos de negocio se soportan con aplicaciones, estas leen y escriben en los datos y todo el conjunto se ejecuta sobre la base tecnológica.

![Dominios de la arquitectura empresarial de EspaciGo](imagenes/figura-ae-dominios.png){width=6.3in} <!--#fig:ae-dominios-->

### Fortalezas, Oportunidades, Debilidades y Amenazas (FODA)

El análisis se construye a partir de los antecedentes del proyecto: la situación del mercado descrita en el capítulo de identificación del problema, las capacidades del equipo y las decisiones de arquitectura y de alcance ya formalizadas.

*Tabla. Análisis FODA de EspaciGo.* <!--#tab:foda-->

| Dimensión | Elementos identificados |
| :--- | :--- |
| **Fortalezas** (internas, positivas) | Modelo de negocio de dos lados (arrendadores y arrendatarios) con ingreso por comisión alineado a la actividad real; verificación de identidad KYC/KYB en línea contra el Registro Civil y el SII; retención de fondos (Escrow) y pre-autorización de garantía que reducen el riesgo de fraude e impago; contratación digital con firma electrónica avanzada; evidencia fotográfica de check-in y check-out y auditoría inmutable de las acciones críticas; arquitectura cloud-native modular con escalamiento automático y costo por uso; documentación de requisitos completa y trazable (236 RF, 43 RNF, 52 casos de uso y 35 historias de usuario) que permite estimar y verificar el alcance; equipo de tres roles complementarios (arquitectura, backend y frontend). |
| **Oportunidades** (externas, positivas) | Vacancia relevante en oficinas clase C, bodegas flex y locales secundarios, que constituye el inventario potencial de la plataforma; demanda creciente de espacios flexibles por parte de pymes, comercio electrónico y actividades creativas; marco normativo de arriendo y de protección de datos que ordena la actividad y favorece la formalización de las operaciones; disponibilidad de APIs maduras de pagos y de firma electrónica; posibilidad de ampliar la oferta a nuevos segmentos y comunas sin modificar la arquitectura; alianzas potenciales con corredores, administradores de bodegas y operadores logísticos. |
| **Debilidades** (internas, negativas) | Equipo reducido y plazo acotado (16 semanas) frente a un alcance amplio; dependencia de proveedores externos críticos (pasarela de pagos, firma electrónica, Registro Civil y SII), cuya indisponibilidad interrumpe flujos completos; modelo de ingresos sensible al volumen transaccional, que exige masa crítica simultánea de oferta y demanda; presupuesto tecnológico acotado frente a los compromisos de disponibilidad y recuperación declarados en los requerimientos no funcionales; ausencia de historial de reputación al momento del lanzamiento; funcionalidades declaradas fuera del alcance de la ES1 (favoritos, centro de ayuda y notificaciones dentro de la aplicación) que pueden afectar la experiencia inicial. |
| **Amenazas** (externas, negativas) | Competencia de clasificados consolidados y de operadores de corretaje o bodegaje con mayor escala; posible entrada de plataformas internacionales de marketplace; cambios regulatorios o interpretaciones más exigentes de las Leyes 21.461 y 21.719 que obliguen a modificar flujos contractuales o de tratamiento de datos; riesgos propios del negocio (daños, morosidad y disputas) que pueden afectar la reputación de la plataforma aunque actúe como intermediaria tecnológica; incidentes de ciberseguridad y fraude; volatilidad económica que reduzca la disposición a arrendar espacios temporales. |

**Conclusiones del análisis.** Las fortalezas se concentran en la confianza transaccional (identidad verificada, fondos retenidos, contratación y evidencia digital) y en la trazabilidad del proyecto; las oportunidades provienen del descalce entre la oferta rígida tradicional y la demanda flexible. Las principales brechas internas son la capacidad operativa del equipo y la dependencia de terceros, que se abordan con la arquitectura modular, la automatización de los flujos y el alcance delimitado de la ES1. Las amenazas externas se gestionan con el cumplimiento normativo, la auditoría inmutable y la diversificación de proveedores prevista en los requerimientos no funcionales.
...
Los anexos de este informe se entregan como **documentos independientes** y se adjuntan a este documento como objetos, en el mismo orden en que son referenciados en el texto. Cada anexo conserva los estilos y la estructura institucional.

## Anexo A — Actores y módulos del sistema

**Documento anexo:** `Anexo_A_Actores_y_modulos_del_sistema.docx`. Contiene el modelo de actores y su generalización, los criterios de construcción de los módulos, los 236 requerimientos funcionales agrupados en los 11 módulos del sistema y el resumen de actores por módulo.

## Anexo B — Catálogo de requerimientos funcionales

**Documento anexo:** `Anexo_B_Catalogo_de_requerimientos_funcionales.docx`. Contiene los 236 requerimientos funcionales en orden de identificador, los requerimientos complementarios de las dos revisiones de completitud y las tablas de brechas cerradas.

## Anexo C — Requerimientos no funcionales

**Documento anexo:** `Anexo_C_Requerimientos_no_funcionales.docx`. Contiene los 43 requerimientos no funcionales, el resumen por categoría, la trazabilidad con los requerimientos funcionales y los módulos, y los cambios aplicados respecto de la versión anterior.

## Anexo D — Especificación de casos de uso

**Documento anexo:** `Anexo_D_Especificacion_de_casos_de_uso.docx`. Contiene las convenciones de modelado, el modelo de actores, los 11 diagramas de casos de uso, las 52 fichas completas con sus flujos, el resumen de trazabilidad módulo → casos de uso → requerimientos y las relaciones UML modeladas y descartadas.

## Anexo E — Historias de usuario

**Documento anexo:** `Anexo_E_Historias_de_usuario.docx`. Contiene las 35 historias de usuario con sus criterios de aceptación, la tabla de trazabilidad HU ↔ RF ↔ CU, la cobertura de los 11 módulos funcionales y el detalle de las correcciones aplicadas.
